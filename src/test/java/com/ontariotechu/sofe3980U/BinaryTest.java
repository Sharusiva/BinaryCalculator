...
public class BinaryTest 
{
    ...
    {
        Binary binary1 = new Binary("110010");
    ...
    {
        Binary binary1 = new Binary("1111111");
        Binary binary2 = new Binary("111");
        Binary binary3 = Binary.multiply(binary1, binary2);
        assertTrue(binary3.getValue().equals("01101111001"));
    }
    // OR tests
      @Test
    public void or1()
    ...
    {
        Binary binary1 = new Binary("110101110");
        Binary binary2 = new Binary("1100");
        Binary binary3 = Binary.or(binary1, binary2);
        assertTrue(binary3.getValue().equals("110101110"));
    }
    // AND tests
    @Test
    public void and1(){
    ...
    @Test
    public void andDifferentSize(){
        Binary binary1 = new Binary("1101");
        Binary binary2 = new Binary("100");// should treat this as 0100
        Binary binary3 = Binary.and(binary1, binary2);
        assertTrue(binary3.getValue().equals("100")); //Strips leading zeros
    }
